...
const Hero = () => {
  return (
    <section className='max-containter padding-container flex flex-col gap-20 py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row'>
        ...
        <div className='relative z-20 flex flex-1 flex-col xl:w-1/2'>
            ...
            <h1 className='bold-52 lg:bold-88'>Putuku Truno Camp Area</h1>
            ...
            <div className='my-11 flex flex-wrap gap-5'>
                ...
                <p className='bold-16 lg:bold-20 text-blue-70'>198k<span className='regular-16 lg:regular-20 ml-1 underline cursor-pointer'>Excellent Reviews</span></p>
            </div>
